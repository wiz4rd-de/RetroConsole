...
- **M6 — Hardware hardening (post-MVP)**: real-hardware matrix (Intel/AMD/NVIDIA), HDMI audio, Bluetooth pads, pixman/gamescope fallbacks, docs.
  *First real-hardware test (2026-06-12, keyboard attached):* live session works end to end (ES-DE, gamepad, bundled NES game). Two bugs found and fixed:
